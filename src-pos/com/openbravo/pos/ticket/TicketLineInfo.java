...
//        
            ...
            attributes.setProperty("product.buyPrice", String.valueOf(product.getPriceBuy()));

        }
        init(pid, null, dMultiply, dPrice, tax, attributes, product.getPriceBuy());
    }
    ...
    private void init(String productid, String attsetinstid, double dMultiply, double dPrice, TaxInfo tax, Properties attributes, double buyPrice) {
